...
public class SQLiteManager extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        query = "CREATE TABLE IF NOT EXISTS "+TABLE_TODO_ITEMS+" ( "+COLUMN_ITEM_ID+" TEXT PRIMARY KEY, "+COLUMN_ITEM_NAME+" TEXT, "+COLUMN_ITEM_STATUS+" TEXT, "+COLUMN_ITEM_TASK_ID+" TEXT, FOREIGN KEY ( "+COLUMN_ITEM_TASK_ID+" ) REFERENCES "+TABLE_TODO_TASKS+" ( "+COLUMN_TASK_ID+" )   )  ";
        sqLiteDatabase.execSQL(query);
